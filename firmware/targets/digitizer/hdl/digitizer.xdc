...
set_property PACKAGE_PIN J23  [get_ports {pwrCtrlIn[tempAlertL][0]}]
set_property PACKAGE_PIN K23  [get_ports {pwrCtrlIn[tempAlertL][1]}]
...
set_property -dict { PACKAGE_PIN M26 IOSTANDARD LVCMOS33 } [get_ports {tmpScl}]
set_property -dict { PACKAGE_PIN L22 IOSTANDARD LVCMOS33 } [get_ports {tmpSda}]

set_property -dict { PACKAGE_PIN M27 IOSTANDARD LVCMOS33 } [get_ports {pwrScl}]
set_property -dict { PACKAGE_PIN L27 IOSTANDARD LVCMOS33 } [get_ports {pwrSda}]
